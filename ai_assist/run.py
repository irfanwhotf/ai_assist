#!/usr/bin/env python3
"""
AI Voice Assistant - Standalone runner

This script allows running the voice assistant directly without package imports.
"""
...
# Add the current directory to the path to allow importing the modules
